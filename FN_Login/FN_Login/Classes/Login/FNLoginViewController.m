...
//    titleLbl.font = PingFangMediumFontSize(28);
...
//        make.top.equalTo(titleLbl.mas_bottom).offset(FNPixelToY(27));
...
//        make.top.equalTo(self.userName.mas_bottom).offset(FNPixelToY(10));
//        make.left.mas_equalTo(kRealWidth(25));
...
//        make.top.equalTo(line2.mas_bottom).offset(FNPixelToY(30));
//        make.left.mas_equalTo(kRealWidth(25));
//        make.right.mas_equalTo(kRealWidth(-25));
